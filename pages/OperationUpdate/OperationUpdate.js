...
this.setData({
  ...
  // 获取学生信息，一起上传
     ...
     let category_id=999;  //category_id为999，说明是作业图片
   ...
   wx.uploadFile({
    url: "https://www.hemantower.com/public/index.php/api/v1/upload/"+std_id+
    "?std_grade="+std_grade+"&category_id="+category_id+"&update_time="+update_time,
...
if(D != stD){
  ...
  that.setData({
    signfens: that.data.signfens+= 10
  })
